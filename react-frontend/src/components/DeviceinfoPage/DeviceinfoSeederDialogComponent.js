...
import seederData from "./deviceinfo.seeder.json";
...
const DeviceinfoSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(DeviceinfoSeederDialogComponent);
