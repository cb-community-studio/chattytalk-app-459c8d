        ...
        <Dialog header="Create" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="users-create-dialog-component">
                ...
                <div>
                    ...
                    <InputText className="w-full mb-3" value={_entity?.about} onChange={(e) => setValByKey("about", e.target.value)}  />
                </div>
                <div>
                    <p className="m-0" >fcmId:</p>
                    <InputText className="w-full mb-3" value={_entity?.fcmId} onChange={(e) => setValByKey("fcmId", e.target.value)}  />
                </div>
                <div>
                    <p className="m-0" >id:</p>
                    <InputText className="w-full mb-3" value={_entity?.id} onChange={(e) => setValByKey("id", e.target.value)}  />
                </div>
                <div>
                ...
                <div>
                    <p className="m-0" >isOnline:</p>
                    <InputText className="w-full mb-3" value={_entity?.isOnline} onChange={(e) => setValByKey("isOnline", e.target.value)}  />
                </div>
                <div>
                    <p className="m-0" >lastActive:</p>
                    <InputText className="w-full mb-3" value={_entity?.lastActive} onChange={(e) => setValByKey("lastActive", e.target.value)}  />
                </div>
